...
define('SITE_NAME','Snack Shack Cafe Admin');
define('FRONT_SITE_NAME','Snack Shack Cafe');


define('FRONT_SITE_PATH','http://127.0.0.1/snack-shack-cafe/');
define('SERVER_IMAGE',$_SERVER['DOCUMENT_ROOT']."/snack-shack-cafe/");
